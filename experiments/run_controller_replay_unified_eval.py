...
def unified_answers_match(dataset: str, pred_answer: str, gold_answer: str) -> bool:
    return bool(
        is_correct_prediction(
            pred_answer,
            gold_answer,
            answer_mode=answer_mode_for_dataset(dataset),
        )
    )
...
def build_trajectory_meta(
    ...
    for r in rows:
        ...
        is_correct = unified_answers_match(dataset, pred, gold)
