...
coverage_fp = OUT_DIR / "three_model_baseline_coverage.md"
lines = []
...
acc_fp = OUT_DIR / "three_model_baseline_acc_table.md"
lines = []
...
# 2) cost table
cost_fp = OUT_DIR / "three_model_baseline_cost_table.md"
lines = []
...
# 3) cost-acc table
trade_fp = OUT_DIR / "three_model_baseline_cost_acc_table.md"
lines = []
...
best_fp = OUT_DIR / "three_model_baseline_best_by_view.md"
lines = []
